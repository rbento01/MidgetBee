...
namespace MidgetBee.Migrations {
    ...
    [Migration("20210702213351_AnimesCategoria1")]
    partial class AnimesCategoria1 {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MidgetBee.Models.AnimesCategoria", b => {
                b.Property<int>("idAnimesCategoria")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
                    .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                b.Property<int>("AnimesFK")
                    .HasColumnType("int");

                b.Property<int>("CategoriaFK")
                    .HasColumnType("int");

                b.HasKey("idAnimesCategoria");

                b.HasIndex("AnimesFK");

                b.HasIndex("CategoriaFK");

                b.ToTable("AnimesCategoria");
            ...
            modelBuilder.Entity("MidgetBee.Models.AnimesCategoria", b => {
                b.HasOne("MidgetBee.Models.Animes", "Animes")
                    .WithMany()
                    .HasForeignKey("AnimesFK")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("MidgetBee.Models.Categorias", "Categorias")
                    .WithMany()
